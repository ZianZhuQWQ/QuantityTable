				...
				<view class="center">
					<view class="center_top">
						...
						<view class="center_info">
							<text>护士{{nurse_id}}</text>
							<!-- <text>病人{{patient_id}}</text> -->
						</view>
					</view>
				</view>
			</view>
	...
	export default {
		...
		data() {
			return {
				...
				pageTitle: "我的",
				// nurse_id: "",
				// nurse_id:this.$store.state.nurseInfoData
		...
		computed: {
			...
			// nurse_id() {
				// return store.state.nurseInfoData.nurse_id 
				// return this.$store.state.nurseInfoData.nurse_id 
			// }
